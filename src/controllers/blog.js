...
module.exports = {
  ...
  create: async (req, res) => {
    req.body.author = req.user.username; //blog olusturmak isteyen kullanici username gonderiyoruz.
  ...
  read: async (req, res) => {
    //? Asagida her farkli kullanici bloga girdiginde post views arttirdim.
    ...
    await Blog.updateOne(
      { _id: req.params.id },
      { post_views: viewedBySet.size } // size = mongoose length'dir.
    );
